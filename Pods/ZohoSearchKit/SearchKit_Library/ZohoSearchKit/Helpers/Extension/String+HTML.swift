...
//  ZohoSearchAppTwo
//
//  Created by hemant kumar s. on 19/12/17.
//  Copyright © 2017 hemant kumar s. All rights reserved.
//

import Foundation

// MARK: Extension of the String class to decode HTML tag entities to textual representation
extension String {
...
private extension String {
    ...
    static let characterEntities: [String: Character] = [
        ...
        // Special cases from Windows-1252.
        "&#128;": "\u{20AC}",
        "&#130;": "\u{201A}",
        "&#131;": "\u{0192}",
        "&#132;": "\u{201E}",
